...
{
    public partial class STKServiceModem : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            InfoReport("Starting STKServiceModem...");
            if (pMainThread == null)
            {
                ...
                pMainThread.Name = "STKServiceModem Main thread! It's need for STKServiceModem's working";
            }
