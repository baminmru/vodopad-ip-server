        ...
        If sz > 0 Then
            If VerifySum(buf, sz) Then
                ...
                If buf(3) = Asc("V") And buf(4) = Asc("Z") And buf(5) = Asc("L") And buf(6) = Asc("J") And buf(7) = Asc("O") And buf(8) = Asc("T") And buf(9) = Asc(" ") Then
                    If bufStr.Contains(" 76.10.00") Or bufStr.Contains(" 76.10.01") Or bufStr.Contains(" 76.10.02") Or bufStr.Contains(" 76.10.03") Or bufStr.Contains(" 76.10.04") Or bufStr.Contains(" 76.10.05") Or bufStr.Contains(" 76.10.06") Then
                        Return True
                    End If
                    Return True
                End If
