...
{
    public partial class ATMService : ServiceBase
    {
        ...
        private ATMServer.TCPServer srv=null;
        ...
        protected override void OnStart(string[] args)
        {
            ...
            InfoReport("Starting ATMService...");
            if (pMainThread == null)
            {
                ...
                pMainThread.Name = "ATMService Main thread! It's need for ATMService's working";
            }
        ...
        private void MainThread()
        {
            ...
            InfoReport("Load config from :" +GetMyDir() + "\\ATMServiceCFG.xml");
            ...
            {
                ErrorReport("Closing ATMService error:" + Ex.Message);
            }
