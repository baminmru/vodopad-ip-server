...
namespace ASSVServerLib
{
    class ASSVDeviceProcessor
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.eventLog1.Source = "ASSVService";
        ...
        {
            InitializeComponent();
            aSocket = new STKTVMain.ASSVSocket(ref transportSocket);
            if (aSocket.HasID == false)
            {
                Console.WriteLine();
                Console.WriteLine("No ASSVID. Close ASSVDeviceProcessor / Socket");
                aSocket.Close();
                return;
            }
            else
...
#region log functions
        ...
        private ASSVServerLib.LogInfo pLogParams = new ASSVServerLib.LogInfo();
