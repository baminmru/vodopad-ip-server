...
#Region "Protected Functions"
        Protected Sub AutoSizeSplitter(Optional ByVal RightMargin As Integer = 0)
            ...
            Dim cItemCollection As CustomPropertyCollection = Item()
            If Not cItemCollection Is Nothing Then
                Dim oGraphics As Drawing.Graphics = Drawing.Graphics.FromHwnd(Me.Handle)

                For Each cItem As CustomProperty In cItemCollection

                    CurWidth = oGraphics.MeasureString(cItem.Name, Me.Font).Width + RightMargin
                    If CurWidth > MaxWidth Then
                        MaxWidth = CurWidth
                    End If
