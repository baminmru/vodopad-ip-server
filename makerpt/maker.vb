    ...
    Private Function ProcessReport(ByVal id As Integer, ByVal TFILE As String, ByVal firstpage As Boolean) As Boolean
        ...
        If TFILE = "" Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                End If
                fileOK = True
                fname = txtTPath_text + "\" + fname
            End If

        Else
            fname = "c:\bami\web\rpt\template\" & TFILE
            sheetname = ""
            fileOK = True
        End If
        ...
        If fileOK Then
            ...
            Try
                workbook =
               SpreadsheetGear.Factory.GetWorkbook(fname,
            ...
            Try
                ...
                outws.PageSetup.PrintGridlines = ws.PageSetup.PrintGridlines
                outws.PageSetup.PaperSize = ws.PageSetup.PaperSize
                outws.PageSetup.Order = ws.PageSetup.Order

                If ws.PageSetup.FitToPages Then
                    outws.PageSetup.FitToPagesTall = ws.PageSetup.FitToPagesTall
                    outws.PageSetup.FitToPagesWide = ws.PageSetup.FitToPagesWide
                    outws.PageSetup.FitToPages = ws.PageSetup.FitToPages
                Else
                    outws.PageSetup.Zoom = ws.PageSetup.Zoom
                End If
