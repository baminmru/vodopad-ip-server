...
arch_final:
    ...
    '    WriteArchToDB = "INSERT INTO " & DBTableName & "(id_bd,DCALL,DCOUNTER,DATECOUNTER,id_ptype,t1,t2,t3,t4,t5,t6,tce1,tce2,tair1,tair2,p1,p2,p3,p4,v1,v2,v3,v4,v5,v6,m1,m2,m3,m4,m5,m6,sp_TB1,sp_TB2,q1,q2,q4,q5,TSUM1,TSUM2,hc_code,hc,hc_1,hc_2) values ("
    ...
    '    WriteArchToDB = WriteArchToDB + Arch.Q4.ToString.Replace(",", ".") + ","
    '    WriteArchToDB = WriteArchToDB + Arch.Q2.ToString.Replace(",", ".") + ","
    '    WriteArchToDB = WriteArchToDB + Arch.Q5.ToString.Replace(",", ".") + ","
...
tarch_final:
    ...
    '    WriteTArchToDB = WriteTArchToDB + tArch.ERRTIME1.ToString.Replace(",", ".") + ","
    '    WriteTArchToDB = WriteTArchToDB + tArch.WORKTIME1.ToString.Replace(",", ".") + ","
    '    WriteTArchToDB = WriteTArchToDB + tArch.WORKTIME1.ToString.Replace(",", ".") + ","
