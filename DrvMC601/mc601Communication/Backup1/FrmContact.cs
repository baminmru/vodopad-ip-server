...
namespace MC601LogView
{
  public class FrmContact : Form
  {
    ...
    {
      Process.Start(string.Format("mailto:{0}?subject={1}&body={2}", (object) "metertool@kamstrup.com", (object) "LogView MULTICAL 601 registration", (object) "For update informations regarding LogView, please register.%0ACompany:%0AContact person:%0ASerial No:%0AOrder No:%0A"));
    }
