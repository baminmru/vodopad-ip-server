  ...
  public class DayLogDataSet : DataSet
  {
    ...
    public class CustomerNoDataTable : DataTable, IEnumerable
    {
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.CustomerNoRowChanged == null)
          return;
        this.CustomerNoRowChanged( this, new DayLogDataSet.CustomerNoRowChangeEvent((DayLogDataSet.CustomerNoRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.CustomerNoRowChanging == null)
          return;
        this.CustomerNoRowChanging( this, new DayLogDataSet.CustomerNoRowChangeEvent((DayLogDataSet.CustomerNoRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.CustomerNoRowDeleted == null)
          return;
        this.CustomerNoRowDeleted( this, new DayLogDataSet.CustomerNoRowChangeEvent((DayLogDataSet.CustomerNoRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.CustomerNoRowDeleting == null)
          return;
        this.CustomerNoRowDeleting( this, new DayLogDataSet.CustomerNoRowChangeEvent((DayLogDataSet.CustomerNoRow) e.Row, e.Action));
      }
    ...
    public class RegisterDataTable : DataTable, IEnumerable
    {
      ...
      private void InitClass()
      {
        ...
        this.columnT1Avr.DefaultValue =  new Decimal(0);
        this.columnT2Avr.DefaultValue =  new Decimal(0);
        this.columnT3Avr.DefaultValue =  new Decimal(0);
        this.columnP1Avr.DefaultValue =  new Decimal(0);
        this.columnP2Avr.DefaultValue =  new Decimal(0);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterRowChanged == null)
          return;
        this.RegisterRowChanged( this, new DayLogDataSet.RegisterRowChangeEvent((DayLogDataSet.RegisterRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterRowChanging == null)
          return;
        this.RegisterRowChanging( this, new DayLogDataSet.RegisterRowChangeEvent((DayLogDataSet.RegisterRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterRowDeleted == null)
          return;
        this.RegisterRowDeleted( this, new DayLogDataSet.RegisterRowChangeEvent((DayLogDataSet.RegisterRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterRowDeleting == null)
          return;
        this.RegisterRowDeleting( this, new DayLogDataSet.RegisterRowChangeEvent((DayLogDataSet.RegisterRow) e.Row, e.Action));
      }
    ...
    public class RegisterUnitDataTable : DataTable, IEnumerable
    {
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterUnitRowChanged == null)
          return;
        this.RegisterUnitRowChanged( this, new DayLogDataSet.RegisterUnitRowChangeEvent((DayLogDataSet.RegisterUnitRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterUnitRowChanging == null)
          return;
        this.RegisterUnitRowChanging( this, new DayLogDataSet.RegisterUnitRowChangeEvent((DayLogDataSet.RegisterUnitRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterUnitRowDeleted == null)
          return;
        this.RegisterUnitRowDeleted( this, new DayLogDataSet.RegisterUnitRowChangeEvent((DayLogDataSet.RegisterUnitRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterUnitRowDeleting == null)
          return;
        this.RegisterUnitRowDeleting( this, new DayLogDataSet.RegisterUnitRowChangeEvent((DayLogDataSet.RegisterUnitRow) e.Row, e.Action));
      }
    ...
    public class RegisterInUseDataTable : DataTable, IEnumerable
    {
      ...
      public DayLogDataSet.RegisterInUseRow AddRegisterInUseRow(bool E1, bool E2, bool E3, bool E4, bool E5, bool E6, bool E7, bool E8, bool E9, bool T1Avr, bool T2Avr, bool T3Avr, bool P1Avr, bool P2Avr, bool V1, bool V2, bool INA, bool INB, bool M1, bool M2, bool INFO)
      {
        ...
        object[] objArray = new object[21]
        {
           ...
           (bool) (E8 ? true : false),
           (bool) (E9 ? true : false),
           (bool) (T1Avr ? true : false),
           (bool) (T2Avr ? true : false),
           (bool) (T3Avr ? true : false),
           (bool) (P1Avr ? true : false),
           (bool) (P2Avr ? true : false),
           (bool) (V1 ? true : false),
           (bool) (V2 ? true : false),
           (bool) (INA ? true : false),
           (bool) (INB ? true : false),
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterInUseRowChanged == null)
          return;
        this.RegisterInUseRowChanged( this, new DayLogDataSet.RegisterInUseRowChangeEvent((DayLogDataSet.RegisterInUseRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterInUseRowChanging == null)
          return;
        this.RegisterInUseRowChanging( this, new DayLogDataSet.RegisterInUseRowChangeEvent((DayLogDataSet.RegisterInUseRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterInUseRowDeleted == null)
          return;
        this.RegisterInUseRowDeleted( this, new DayLogDataSet.RegisterInUseRowChangeEvent((DayLogDataSet.RegisterInUseRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.RegisterInUseRowDeleting == null)
          return;
        this.RegisterInUseRowDeleting( this, new DayLogDataSet.RegisterInUseRowChangeEvent((DayLogDataSet.RegisterInUseRow) e.Row, e.Action));
      }
    ...
    public class RegisterRow : DataRow
    {
      ...
      public Decimal T1Avr
      {
        ...
        set
        {
          this[this.tableRegister.T1AvrColumn] =  value;
        }
      }
      ...
      public Decimal T2Avr
      {
        ...
        set
        {
          this[this.tableRegister.T2AvrColumn] =  value;
        }
      }
      ...
      public Decimal T3Avr
      {
        ...
        set
        {
          this[this.tableRegister.T3AvrColumn] =  value;
        }
      }
      ...
      public Decimal P1Avr
      {
        ...
        set
        {
          this[this.tableRegister.P1AvrColumn] =  value;
        }
      }
      ...
      public Decimal P2Avr
      {
        ...
        set
        {
          this[this.tableRegister.P2AvrColumn] =  value;
        }
      }
      ...
      public Decimal M1
      {
        ...
        set
        {
          this[this.tableRegister.M1Column] =  value;
        }
      }
      ...
      public Decimal M2
      {
        ...
        set
        {
          this[this.tableRegister.M2Column] =  value;
        }
      }
    ...
    public class RegisterUnitRow : DataRow
    {
      ...
      public byte T1Avr
      {
        ...
        set
        {
          this[this.tableRegisterUnit.T1AvrColumn] =  value;
        }
      }
      ...
      public byte T2Avr
      {
        ...
        set
        {
          this[this.tableRegisterUnit.T2AvrColumn] =  value;
        }
      }
      ...
      public byte T3Avr
      {
        ...
        set
        {
          this[this.tableRegisterUnit.T3AvrColumn] =  value;
        }
      }
      ...
      public byte P1Avr
      {
        ...
        set
        {
          this[this.tableRegisterUnit.P1AvrColumn] =  value;
        }
      }
      ...
      public byte P2Avr
      {
        ...
        set
        {
          this[this.tableRegisterUnit.P2AvrColumn] =  value;
        }
      }
    ...
    public class RegisterInUseRow : DataRow
    {
      ...
      public bool T1Avr
      {
        ...
        set
        {
          this[this.tableRegisterInUse.T1AvrColumn] =  (bool) (value ? true : false);
        }
      }
      ...
      public bool T2Avr
      {
        ...
        set
        {
          this[this.tableRegisterInUse.T2AvrColumn] =  (bool) (value ? true : false);
        }
      }
      ...
      public bool T3Avr
      {
        ...
        set
        {
          this[this.tableRegisterInUse.T3AvrColumn] =  (bool) (value ? true : false);
        }
      }
      ...
      public bool P1Avr
      {
        ...
        set
        {
          this[this.tableRegisterInUse.P1AvrColumn] =  (bool) (value ? true : false);
        }
      }
      ...
      public bool P2Avr
      {
        ...
        set
        {
          this[this.tableRegisterInUse.P2AvrColumn] =  (bool) (value ? true : false);
        }
      }
