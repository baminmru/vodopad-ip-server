...
{
    public partial class ASSVService : ServiceBase
    {
        ...
        private ASSVServerLib.TCPServer srv=null;
        ...
        protected override void OnStart(string[] args)
        {
            ...
            InfoReport("Starting ASSVService...");
            if (pMainThread == null)
            {
                ...
                pMainThread.Name = "ASSVService Main thread! It's need for ASSVService's working";
            }
