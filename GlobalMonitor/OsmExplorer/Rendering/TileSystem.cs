...
namespace OsmExplorer.Rendering
{
    public static class TileSystem
    {
        ...
        private const double MinLatitude = -89.90;
        private const double MaxLatitude = 89.90;
        ...
        public static void LatLonToPixelXY(double latitude, double longitude, int levelOfDetail, out int pixelX, out int pixelY)
        {
            latitude = Clip(latitude, MinLatitude, MaxLatitude);
