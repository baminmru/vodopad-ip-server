create or replace procedure si6tsr(p IN varchar2,sdate IN varchar2, edate IN varchar2)
AUTHID CURRENT_USER
IS
...
--     ORDER BY "Дата" desc;
 ...
 utl_file.put_line(fd,'дд.мм.гггг'||chr(9)||'ч'||chr(9)||'т'||chr(9)||'м3'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'Гкал'||chr(9)||'т'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'мин'||chr(9)||'мин'||chr(9)||'мин'||chr(9)||'-');
     LOOP
         FETCH cdat INTO
