create or replace procedure SI5SPT943(p IN varchar2, sdate IN varchar2, edate IN varchar2)
AUTHID CURRENT_USER
IS
/* правка 2013.11.28 для узла АТС 700 4-е трубы по просьбе Сушанского */
