create or replace procedure si2spt942gv5(p IN varchar2,sdate IN varchar2,edate IN varchar2)
AUTHID CURRENT_USER
IS
...
--  chour datacurr.dcounter%type;
  ...
  cV2   varchar2(10);
  cP2   varchar2(10);
  cW2   varchar2(10);--datacurr.q2%type; -- q2 --> W тепловая энергии данные отсутствуют
  ...
  cW1g  varchar2(10);--datacurr.q3%type; -- q2 W тепловая энергия ГВС
...
OPEN cdat FOR
     select
            ...
            NVL(TO_CHAR(trunc(c.v1,2)),'-'), -- 4 данные есть!
            ...
            NVL(TO_CHAR(trunc(c.V2,2)),'-'), -- 9 
            NVL(TO_CHAR(trunc(c.t2,6)),'-'), -- 10
            NVL(TO_CHAR(trunc(c.P2,6)),'-'), -- 11 11.09.2008 данные есть
            '-', --NVL(TO_CHAR(trunc(c.q2,6)),'-'),  -- 12 W2 тепловая энергия данные отсутствуют
            NVL(TO_CHAR((trunc(c.m1,6)-trunc(c.m2,6))),'-'),-- as "dM12", -- 13 dM12
            '-', --NVL(TO_CHAR((trunc(c.q1,6)-trunc(c.q2,6))),'-'), -- as "dW12", -- 14 dW12 значения нет
            -- ГВС --------------------------------------
            NVL(TO_CHAR(trunc(c.m5,2)),'-'),-- 15 M1гвс
            NVL(TO_CHAR(trunc(c.v5,6)),'-'), -- 16 V1гвс
            NVL(TO_CHAR(trunc(c.t5,2)),'-'), -- 17 T1гвс
            '-', --NVL(TO_CHAR(trunc(c.p4,2)),'-'), -- 18 P1гвс значения давления нет
            NVL(TO_CHAR(trunc(c.q2,2)),'-'), -- 19 W1гвс 
            '-', --NVL(TO_CHAR(trunc(c.tcool,2)),'-'), -- 20 TCool -> tхв значения нет
            '-', --NVL(TO_CHAR(trunc(c.pxb,2)),'-'), -- 21 PXB -> Pxv значения нет
...
--                              TO_CHAR(chour)  ||chr(9)||
                              TO_CHAR(cM1)    ||chr(9)|| -- 3
                              TO_CHAR(cV1)    ||chr(9)|| -- 4 V1 попадает из M1????????????
                              TO_CHAR(cT1)    ||chr(9)|| -- 5
                              TO_CHAR(cP1)    ||chr(9)|| -- 6 P1
                              TO_CHAR(cW1)    ||chr(9)|| -- 7
                              TO_CHAR(cM2)    ||chr(9)|| -- 8
                              TO_CHAR(cV2)    ||chr(9)|| -- 9 V2
                              TO_CHAR(cT2)    ||chr(9)|| -- 10
                              TO_CHAR(cP2)    ||chr(9)|| -- 11 P2
                              TO_CHAR(cW2)    ||chr(9)|| -- 12
                              TO_CHAR(cdM)    ||chr(9)|| -- 13
                              TO_CHAR(cdW)    ||chr(9)|| -- 14 dW
                              TO_CHAR(cM1g)   ||chr(9)|| -- 15 M1g
