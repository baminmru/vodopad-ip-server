create or replace procedure si5tsr(p IN varchar2,sdate IN varchar2,edate IN varchar2)
AUTHID CURRENT_USER
IS
nodename          varchar2(24);--:= 'АТС 750';
--nodename = p;
...
--  chour datacurr.dcounter%type;
  ...
  cW1   varchar2(12);--datacurr.q1%type; -- Q --> W тепловая энергии
  cM2   varchar2(12);--datacurr.m2%type;
  cT2   varchar2(12);--datacurr.T2%type;
  cV2   varchar2(12);
  cP2   varchar2(12);
  cW2   varchar2(12);--datacurr.q2%type; -- Q --> W тепловая энергии
  cdM   varchar2(12);--datacurr.dm12%type;
  cdW   varchar2(12);--datacurr.dg12%type;
  cM1g  varchar2(12);--datacurr.m3%type; --M1гвс m3 -> M1гвс ??????????????????????????????????????????????
  cV1g  varchar2(12);--datacurr.V3%type; -- V3 -> V1гвс ?????????????????????
  cT1g  varchar2(12);--datacurr.t3%type; -- T3 -> T1гвс ????????????????????
  cP1g  varchar2(12);--datacurr.p3%type;
  cW1g  varchar2(12);--datacurr.q3%type;
  ---/* недостающие параметры 01.10.2007 */
  cM2g   varchar2(12); -- M2гв
  cV2g   varchar2(12); -- V2гв
  cT2g   varchar2(12); -- t2гв
  cP2g   varchar2(12); -- P2гв
  cW2g   varchar2(12); -- W2гв
  cdMg   varchar2(12); -- dMгв
  cdWg   varchar2(12); -- dWгв
  ---
  cTxv  varchar2(12);--datacurr.tcool%type; --TCool -> tхв ??????????
  cPxv  varchar2(12);--datacurr.pxb%type; -- PXB -> Pхв ?????
  cT_o  varchar2(12);
  cTp   varchar2(12);
  cToo  varchar2(12);
  cTog  varchar2(12);
...
OPEN cdat FOR
     select
            ...
            NVL(TO_CHAR(trunc(c.v1,6)),'-'), -- 4 данные отсутствуют ???? данные есть!
            NVL(TO_CHAR(trunc(c.t1,6)),'-'), -- 5
            NVL(TO_CHAR(c.P1),'-'), -- 6 данные отсутствуют
            NVL(TO_CHAR(trunc(c.q1,6)),'-'),  -- 7 W1 тепловая энергия
            NVL(TO_CHAR(trunc(c.M2,6)),'-'), -- 8
            NVL(TO_CHAR(trunc(V2,6)),'-'), -- 9 данные отсутствуют!
            NVL(TO_CHAR(trunc(c.t2,6)),'-'), -- 10
            NVL(TO_CHAR(trunc(c.P2,6)),'-'), -- 11 данные отсутствуют
            ...
            NVL(TO_CHAR(trunc(c.m4,6)),'-'),                 -- 15 M1гвс? данные отсутствуют?
            NVL(TO_CHAR(trunc(c.v4,6)),'-'),                 -- 16 V1гвс??????
            '-',--NVL(TO_CHAR(trunc(c.t4,2)),'-'),           -- 17 T1гвс данные отсутствуют!!!
            NVL(TO_CHAR(trunc(c.p4,6)),'-'),                 -- 18 P1гвс ?
            NVL(TO_CHAR(trunc(c.q4,6)),'-'),                 -- 19 W1гвс ?
            ---/* недостающие параметры 01.10.2007 */
            NVL(TO_CHAR(trunc(c.M5,6)),'-'), -- 20 M2гв
            NVL(TO_CHAR(trunc(c.V5,6)),'-'), -- 21 V2гв ??
            NVL(TO_CHAR(trunc(c.T5,6)),'-'), -- 22 t2гв
            NVL(TO_CHAR(trunc(c.P5,6)),'-'), -- 23 P2гв ??
            NVL(TO_CHAR(trunc(c.Q5,6)),'-'), -- 24 W2гв ??
...
--     ORDER BY "Дата" desc;
 ...
 utl_file.put_line(fd,'дд.мм.гггг'||chr(9)||'ч'||chr(9)||'т'||chr(9)||'м3'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'Гкал'||chr(9)||'т'||chr(9)||'м3'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'Гкал'||chr(9)||'т'||chr(9)||'Гкал'||chr(9)||'т'||chr(9)||'м3'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'Гкал'||chr(9)||'т'||chr(9)||'м3'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'Гкал'||chr(9)||'т'||chr(9)||'Гкал'||chr(9)||'гр.C'||chr(9)||'кгс/см2'||chr(9)||'мин'||chr(9)||'мин'||chr(9)||'мин'||chr(9)||'мин'||chr(9)||'-');
     LOOP
         FETCH cdat INTO
               cdata,chour,cM1,cV1,cT1,cP1,cW1,cM2,cV2,cT2,--10
               cP2,cW2,cdM,cdW,cM1g,cV1g,cT1g,cP1g,cW1g,cTxv,--20
               cM2g,cV2g,cT2g,cP2g,cW2g,cdMg,cdWg,  -- 27 /* недостающие параметрв 01.10.2007 */
...
--                            M2гв,V2гв,t2гв,P2гв,W2гв,dMгв,dWгв
                              TO_CHAR(cM2g)   ||chr(9)||--M2гв
                              TO_CHAR(cV2g)   ||chr(9)||--V2гв
                              TO_CHAR(cT2g)   ||chr(9)||--t2гв
                              TO_CHAR(cP2g)   ||chr(9)||--P2гв
                              TO_CHAR(cW2g)   ||chr(9)||--W2гв
                              TO_CHAR(cdMg)   ||chr(9)||--dMгв
                              TO_CHAR(cdWg)   ||chr(9)||--dWгв
                              --
