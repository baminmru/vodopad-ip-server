CREATE TABLE "COUNTERS"."QLIST" 
  ...
  ALTER TABLE "COUNTERS"."QLIST" MODIFY ("QLISTID" NOT NULL ENABLE);
   ...
   COMMENT ON COLUMN "COUNTERS"."QLIST"."PROCESSED" IS '0 - в очереди  1 - идет опрос 2 - отработан';

   COMMENT ON COLUMN "COUNTERS"."QLIST"."QDATE" IS 'ƒата начала опроса';
   COMMENT ON TABLE "COUNTERS"."QLIST"  IS '«апрос на опрос архивов';
