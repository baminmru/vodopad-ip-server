create or replace view v_datacurr as
select 
bbuildings.CSHORT as "Здание",
...
datacurr.*
 from datacurr
 left join PARAMTYPE on PARAMTYPE.ID_TYPE=id_PTYPE
 left join bdevices on datacurr.id_bd=bdevices.id_bd
 left join bbuildings on bbuildings.id_bu=bdevices.id_bu

  
--select * from bdevices
--select * from bbuildings
