create or replace procedure BAMI_si2spt943(p IN varchar2,sdate IN varchar2,edate IN varchar2)
AUTHID CURRENT_USER
IS
...
OPEN cdat FOR
     select
            ...
            NVL(TO_CHAR(trunc(c.m3,6)),'-'),-- 15 M1гвс 2009.04.15 данные есть OK!
