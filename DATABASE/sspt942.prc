create or replace procedure SSPT942(pprz varchar2,pid_bd varchar2,pdt varchar2,pptype varchar2,
...
begin
  ...
  if pprz = '3' then
    update datacurr set p1=ToNumber(pp1),p2=ToNumber(pp2),t1=ToNumber(pt1),
  ...
  if pprz = '1' then
    update datacurr set p1=ToNumber(pp1),p2=ToNumber(pp2),t1=ToNumber(pt1),t2=ToNumber(pt2),
