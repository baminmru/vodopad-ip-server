create or replace procedure BAMI_si2spt942(p IN varchar2,sdate IN varchar2,edate IN varchar2)
AUTHID CURRENT_USER
IS
...
fetch header_1_cur into n_dogovor,kod_scheme,kod_vich,n_vich,
      ...
      --utl_file.fremove('d:\database\utl', to_char(sysdate-1,'DD-MON')||'_'||nodename||'.txt');
