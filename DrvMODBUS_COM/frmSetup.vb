...
Public Class frmSetup
    ...
    Private Sub SaveDataToBase()
        SaveSetting("DrvMODBUS_COM", "setup", "PORT", txtCOM.Text)
        Try
            Integer.Parse(txtRate.Text)
            SaveSetting("DrvMODBUS_COM", "setup", "BAUD", txtRate.Text)
        Catch
            SaveSetting("DrvMODBUS_COM", "setup", "BAUD", "115200")
        End Try
    ...
    Private Sub LoadTextFromBase()
        ...
        txtCOM.Text = GetSetting("DrvMODBUS_COM", "setup", "PORT", "COM4")

        txtRate.Text = GetSetting("DrvMODBUS_COM", "setup", "BAUD", "115200")
