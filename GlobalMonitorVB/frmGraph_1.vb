...
Public Class frmGraph
    ...
    Private Function MakeChartQuery(ByVal chart As Infragistics.Win.UltraWinChart.UltraChart, ByVal Chartnum As Integer) As String
        ...
        For i = 0 To dt.Rows.Count - 1
            ...
            cmd2.CommandText = "select ismin,ismax from valuebounds  where id_bd=" + id.ToString() + " and ptype=" + ptype.ToString() + " and pname='" + pp + "'"
            dt2 = New DataTable
            ...
            If dt2.Rows.Count > 0 Then
                ...
                If dt2.Rows(0)("ISMIN") = 1 Then
                    ...
                    joinlist = joinlist + " left join valuebounds " + pp + "min on " + pp + "min.id_bd = d.id_bd and " + pp + "min.ptype=d.id_ptype and " + pp + "min.pname='" + pp + "' and " + pp + "min.ismin=1"
                    paintElement1 = New Infragistics.UltraChart.Resources.Appearance.PaintElement()
                    paintElement1.ElementType = Infragistics.UltraChart.Shared.Styles.PaintElementType.Gradient
                ...
                If dt2.Rows(0)("ISMAX") = 1 Then
                    ...
                    joinlist = joinlist + " left join valuebounds " + pp + "max on " + pp + "max.id_bd = d.id_bd and " + pp + "max.ptype=d.id_ptype and " + pp + "max.pname='" + pp + "' and " + pp + "max.ismax=1"
                    paintElement1 = New Infragistics.UltraChart.Resources.Appearance.PaintElement()
                    paintElement1.ElementType = Infragistics.UltraChart.Shared.Styles.PaintElementType.Gradient
    ...
    Public Sub LoadData(ByVal newID As Integer, ByVal NodeName As String)
        id = newID
        mName = NodeName
        Me.Text = "Графики по узлу: " + NodeName

        ClearGraph()

        dto = Date.Now
        dfrom = dto.AddHours(-8)
        Try
